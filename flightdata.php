...
$options = array(
        ...
        //起點氣象
        $params_ori_weather = array("airportCode" => $params_ori, "startTime" => 0, "howMany" => 1, "offset" => 0)
        ...
        //終點氣象
        $params_des_weather = array("airportCode" => $params_des, "startTime" => 0, "howMany" => 1, "offset" => 0)
